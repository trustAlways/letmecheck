...
package com.example.candid_20.kindlycheckapp.PwdStrength;
...
public enum PasswordStrength {
  ...
  VERY_STRONG(R.string.password_strength_very_strong, R.color.colorPrimaryDark);

  //--------REQUIREMENTS--------
  static int REQUIRED_LENGTH = 5;
